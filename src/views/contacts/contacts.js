...
import { layoutTemplate } from "../layout/layoutTemplate.js";

const contactsTemplate = () => html`
  <div class="page-content" style="pointer-events: auto;">
    <div class="contact">
      <div style="opacity: 1; transform: none;">
        <div>
          <div class="page-head"><h1 class="page-title">Contacts</h1></div>
      ...
      <div class="contact-content">
        <div class="contact-left">
          <table>
            <tbody>
              <tr>
                <td style="opacity: 1; transform: none;"><h6>Email</h6></td>
                <td style="opacity: 1; transform: none;">
                  <div class="link-wrapper">
                    <div class="link">
                      <a
                        href="mailto:ridvans@abv.bg"
                        target="_blank"
                        rel="noreferrer"
                        >↗ ridvans@abv.bg</a
                      >
                      ...
                      <div class="link-wrapper">
                        <div class="link">
                          ...
                          >
                            ...
                            <span class="f6 dib">LinkedIn</span>
                          </a>
                        </div>
                        <div
                          class="link-underline"
